...
*   **Testbed Tours & Site Visits:** The UNL team conducts continuous reviews of the Advanced Optical Communication (AOC) Testbed at IIT Madras (accessible online via [aoctestbed.in](https://www.aoctestbed.in/)). This field-deployed multi-core fiber network contains alternating underground (4.07 km) and aerial (1.20 km) uncompressed cabling installations configured with loopbacks for ultra-long reach loops.
...
*   **Mohammad Arafath Uddin Shariff (UNL Graduate Researcher):** Focuses on exploring advanced optical simulation platforms and anomaly-aware deep learning for network traffic prediction. Successfully defended his Master's thesis in August 2025.
...
* **Sarat Sasank Barla (UNL Graduate Researcher):** Engaged in developing data-driven and machine learning-based methods to support efficient resource allocation.
